...
```{r}
build_newsapi_url <- function(subject, start_date, end_date, api_key) {
  #base url from website
  base_url <- "https://newsapi.org/v2/everything?"
  
  #checking date format is correct - just make a simple stop if incorrect format
...
```{r}
build_newsapi_url("sports", "2025-06-12", "2025-06-15", "e09f041046584e7c85072592a8add194")
